...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (!info) return { title: 'Medicamento - MediCompara' }
  return {
    title: `${info.activeIngredient} - Informacion y precios - MediCompara`,
        ...
        <section className="bg-white/70 backdrop-blur-[20px] border border-white/50 rounded-2xl shadow-sm overflow-hidden">
          ...
          <div className="mx-5 sm:mx-6 my-4 flex items-start gap-2 bg-[#f5f6fa] rounded-xl p-3">
            ...
            <p className="text-[11px] text-[#717786] leading-relaxed">
              MediCompara no vende medicamentos, no procesa pagos y no es responsable de las transacciones realizadas en sitios de terceros. Cada farmacia es un negocio independiente.{' '}
