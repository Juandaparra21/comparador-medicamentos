...
export default function RegisterClient() {
    ...
    return (
      <div className="flex flex-col items-center gap-4 py-8 text-center">
        ...
        <p className="text-[13px] text-[#717786] max-w-xs">
          El registro estara disponible muy pronto. Mientras tanto puedes usar la busqueda y la lista de deseos sin cuenta.
        </p>
        <Link
          href="/"
  ...
  return (
    <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-4">
        ...
        {password.length > 0 && (
          <div className="mt-2 flex flex-col gap-2">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span
                className="text-[11px] font-bold ml-1 whitespace-nowrap transition-colors duration-300"
              ...
              {strength.criteria.map((c) => (
                <div key={c.label} className="flex items-center gap-1.5">
                  {c.met ? (
                    ...
                    <svg className="w-3.5 h-3.5 text-[#c1c6d7] shrink-0" viewBox="0 0 20 20" fill="currentColor">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.28 7.22a.75.75 0 00-1.06 1.06L8.94 10l-1.72 1.72a.75.75 0 101.06 1.06L10 11.06l1.72 1.72a.75.75 0 101.06-1.06L11.06 10l1.72-1.72a.75.75 0 00-1.06-1.06L10 8.94 8.28 7.22z" clipRule="evenodd" />
                    </svg>
                  )}
                  <span
                    className="text-[11px] transition-colors duration-200"
                    style={{ color: c.met ? '#414755' : '#c1c6d7' }}
                  >
                    {c.label}
                  </span>
                </div>
      ...
      <button
        type="submit"
        className="w-full py-3 rounded-xl bg-gradient-to-r from-primary to-tertiary text-white text-[14px] font-bold hover:opacity-90 transition-opacity cursor-pointer shadow-[0_4px_16px_rgba(0,88,188,0.25)] mt-1"
      >
        Crear cuenta
      </button>
      ...
      <div className="flex items-center gap-3 my-1">
        ...
        <span className="text-[11px] text-[#c1c6d7] font-medium">o registrate con</span>
        <div className="flex-1 h-px bg-[#e5e7eb]" />
      </div>
