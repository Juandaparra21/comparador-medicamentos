...
Para ejercer tus derechos o hacer consultas sobre privacidad, puedes contactarnos en: farmiya001@gmail.com`,
  ...
  {
    title: '2. Marco legal',
    body: `Esta politica se rige por la Ley Estatutaria 1581 de 2012 de Colombia (Proteccion de Datos Personales), el Decreto 1377 de 2013 y demas normas concordantes sobre Habeas Data.`,
  },
  {
    title: '3. Datos que recolectamos',
    body: `Uso anonimo (sin registro):
- No recolectamos datos personales identificables.
- Podemos usar cookies tecnicas anonimas para el funcionamiento de la plataforma (por ejemplo, preferencias de busqueda guardadas en tu dispositivo).

Uso con registro (cuenta):
- Correo electronico: para autenticacion e identificacion de la cuenta.
- Historial de busquedas y favoritos: almacenados en tu cuenta para funcionalidades de la plataforma.
...
NO recolectamos datos sensibles (salud, finanzas, biometria, etc.).`,
  },
  {
    ...
    body: `Tratamos tus datos unicamente para:
...
- Mejorar el servicio mediante analisis agregados y anonimizados.
...
- Proveedores de infraestructura tecnica (Supabase, Vercel) bajo contratos de confidencialidad y conforme a sus politicas de privacidad.
- Cuando sea exigido por autoridad competente colombiana conforme a la ley.

Las farmacias listadas en la plataforma son negocios independientes. No compartimos tu informacion con ellas.`,
  },
  {
...
- Actualizarlos o corregirlos si estan desactualizados o son inexactos.
- Solicitar su eliminacion cuando consideres que no hay causa legal para su tratamiento.
- Revocar la autorizacion de tratamiento.
- Presentar quejas ante la Superintendencia de Industria y Comercio (SIC).

Para ejercer cualquiera de estos derechos escribe a farmiya001@gmail.com con el asunto "Habeas Data - [tu nombre]". Responderemos en un plazo maximo de 10 dias habiles.`,
  },
  {
    title: '7. Almacenamiento y seguridad',
    body: `Tus datos se almacenan en servidores seguros operados por Supabase con cifrado en transito (TLS) y en reposo. Aplicamos medidas tecnicas y organizativas razonables para proteger tu informacion.

Conservamos los datos de cuenta mientras la cuenta este activa. Si eliminas tu cuenta, eliminamos o anonimizamos tus datos en un plazo de 30 dias.`,
  },
  {
    title: '8. Cookies y almacenamiento local',
    body: `Usamos almacenamiento local del navegador (localStorage) para:
- Guardar temporalmente el historial de busquedas en tu dispositivo (no en nuestros servidores).
- Guardar preferencias de la interfaz (como si cerraste el aviso de disclaimer medico).
...
No utilizamos cookies de seguimiento o publicidad de terceros.`,
  ...
  },
  {
    ...
    body: `Podemos actualizar esta politica para reflejar cambios legales o en el servicio. La fecha de actualizacion aparece al inicio de este documento. El uso continuado de la plataforma implica la aceptacion de los cambios.`,
  },
]
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 sm:px-5 py-8 sm:py-12">
      ...
      <nav className="flex items-center gap-2 text-[12px] text-[#717786] mb-6">
        ...
        <span>/</span>
        <span className="text-[#1a1b1f] font-medium">Politica de privacidad</span>
      </nav>
      ...
      <div className="mb-8">
        ...
        <p className="text-[13px] text-[#717786] mt-2">
          Ultima actualizacion: junio de 2026. Conforme a la Ley 1581 de 2012 de Colombia.
        </p>
      </div>

      {/* Resumen */}
      <div className="bg-primary/5 border border-primary/15 rounded-2xl p-5 sm:p-6 mb-8">
        <p className="text-[13px] font-bold text-primary mb-3">Resumen rapido</p>
        <ul className="space-y-2">
          {[
            'Sin cuenta no guardamos ningun dato personal tuyo.',
            'Con cuenta solo guardamos tu correo y tus favoritos. Nada mas.',
      ...
      <div className="mt-8 bg-secondary/5 border border-secondary/15 rounded-2xl p-5 sm:p-6">
        ...
        <a
          href="mailto:farmiya001@gmail.com?subject=Habeas%20Data"
