...
export default async function PrecioPage({ params }: Props) {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 sm:px-5 py-8 sm:py-12 space-y-6">
      ...
      {/* Transparencia: aún no indexada */}
      <div className="flex gap-3 bg-primary/[0.06] border border-primary/15 rounded-xl p-4">
        <svg className="w-5 h-5 text-primary shrink-0 mt-0.5" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
          <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a.75.75 0 000 1.5h.253a.25.25 0 01.244.304l-.459 2.066A1.75 1.75 0 0010.747 15H11a.75.75 0 000-1.5h-.253a.25.25 0 01-.244-.304l.459-2.066A1.75 1.75 0 009.253 9H9z" clipRule="evenodd" />
        </svg>
        <p className="text-[12px] text-[#414755] leading-relaxed">
          <span className="font-semibold text-[#1a1b1f]">Página nueva:</span> aún no aparece en los
          resultados de Google. Está optimizada para posicionarse pronto una vez sea indexada; mientras
          tanto, ya puedes comparar aquí el precio real de {lc}.
        </p>
      </div>
