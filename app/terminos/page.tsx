...
export const metadata: Metadata = {
  title: 'Condiciones del sitio - FarmiYa',
  description: 'Terminos de uso, condiciones y aviso legal de FarmiYa, comparador de precios de medicamentos en Colombia.',
}

const sections = [
  {
    title: '1. Que es FarmiYa',
    body: `FarmiYa es una plataforma gratuita de comparacion de precios de medicamentos en Colombia. Su unico proposito es mostrar al usuario los precios publicados por farmacias y droguerias para que pueda tomar decisiones de compra informadas.

FarmiYa no es una farmacia, no vende medicamentos, no gestiona inventarios y no interviene en ninguna transaccion comercial entre el usuario y los establecimientos listados.`,
  },
  {
    title: '2. Naturaleza de la informacion de precios',
    body: `Los precios mostrados en FarmiYa son obtenidos de fuentes publicas (sitios web de farmacias, APIs oficiales y fuentes equivalentes) con fines estrictamente informativos. Pueden existir diferencias entre el precio publicado y el precio real al momento de la compra debido a:
...
FarmiYa no garantiza la exactitud, vigencia ni disponibilidad de los precios mostrados.`,
  },
  {
    title: '3. Sitios de terceros',
    body: `Cada farmacia listada en FarmiYa es un negocio independiente y autónomo. Al hacer clic en "Comprar" o en cualquier enlace que lleve a un sitio externo, el usuario sera redirigido al sitio web oficial de esa farmacia.

FarmiYa no es responsable de:
...
Recomendamos al usuario verificar siempre el precio directamente en el sitio de la farmacia antes de completar cualquier compra.`,
  },
  {
    ...
    body: `La informacion sobre medicamentos publicada en FarmiYa (usos, dosis, advertencias, contraindicaciones y efectos secundarios) tiene caracter exclusivamente educativo e informativo. No constituye consejo medico, diagnostico ni prescripcion.

Antes de iniciar, modificar o suspender cualquier tratamiento farmacologico, consulte siempre a un medico o farmaceutico licenciado. FarmiYa no asume ninguna responsabilidad por decisiones de salud tomadas con base en el contenido de esta plataforma.`,
  },
  {
    title: '5. Gratuidad del servicio',
    body: `El uso basico de FarmiYa es gratuito para los usuarios. No intervenimos en el precio que paga el usuario al momento de comprar en una farmacia.
...
La plataforma puede incorporar modelos de monetizacion en el futuro, los cuales seran claramente identificados como tal.`,
  },
  {
    ...
    body: `Los nombres, logotipos y marcas de las farmacias listadas son propiedad de sus respectivos duenos y se utilizan con fines referenciales e informativos. FarmiYa no reclama derechos sobre dichas marcas.

El diseño, codigo y contenido propio de FarmiYa son propiedad de sus desarrolladores.`,
  },
  {
    title: '7. Privacidad de datos',
    body: `FarmiYa no solicita datos personales sensibles para el uso basico de la plataforma. En caso de registro voluntario, los datos proporcionados se utilizan unicamente para funcionalidades como guardar favoritos o historial de busquedas, y no son compartidos con terceros con fines comerciales.

En desarrollo: politica de privacidad completa conforme a la Ley 1581 de 2012 (Habeas Data, Colombia).`,
  },
  {
    title: '8. Modificaciones',
    body: `FarmiYa se reserva el derecho de modificar estas condiciones en cualquier momento. Los cambios se publicaran en esta misma pagina. El uso continuado de la plataforma despues de una modificacion implica la aceptacion de los nuevos terminos.`,
  },
]
    ...
    <div className="mx-auto max-w-2xl px-4 sm:px-5 py-8 sm:py-12">
      ...
      <div className="bg-primary/5 border border-primary/15 rounded-2xl p-5 sm:p-6 mb-8">
        ...
        <ul className="space-y-2 mt-3">
          {[
            'FarmiYa compara precios. No vendemos medicamentos ni cobramos nada.',
